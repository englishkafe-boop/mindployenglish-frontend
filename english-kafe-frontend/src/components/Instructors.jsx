function Instructors() {
  return (
    <section className="relative px-4 sm:px-6 md:px-10 py-8 sm:py-12 md:py-20 bg-white">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6 md:gap-8 mb-10 sm:mb-12 md:mb-16">
          ...
          <div className="relative group w-full rounded-3xl overflow-hidden">
        ...
        <div className="bg-gray-50 rounded-2xl p-4 sm:p-6 md:p-8 lg:p-12 max-w-4xl mx-auto">
          <h3 className="text-center text-lg sm:text-xl md:text-2xl font-semibold text-gray-800 mb-6 sm:mb-8">
            What will you get:
          </h3>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6 md:gap-8">
            ...
            <div className="flex items-start gap-3 sm:gap-4">
              <div className="w-5 sm:w-6 h-5 sm:h-6 rounded-full flex items-center justify-center shrink-0 mt-0.5" style={{backgroundColor: "#FCDCE2"}}>
